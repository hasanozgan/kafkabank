...
public class Transaction extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5213844704232297090L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Transaction\",\"namespace\":\"com.hasanozgan.kafkabank.models\",\"fields\":[{\"name\":\"transaction_type\",\"type\":{\"type\":\"enum\",\"name\":\"TransactionType\",\"symbols\":[\"OPENING\",\"WITHDRAW\",\"DEPOSIT\"]}},{\"name\":\"customer_id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"amount\",\"type\":\"double\",\"default\":0},{\"name\":\"is_fraud\",\"type\":\"boolean\",\"default\":false},{\"name\":\"transaction_time\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"},\"doc\":\"transaction time\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }
  @Deprecated public com.hasanozgan.kafkabank.models.TransactionType transaction_type;
  @Deprecated public java.lang.String customer_id;
  @Deprecated public double amount;
  @Deprecated public boolean is_fraud;
  /** transaction time */
  @Deprecated public org.joda.time.DateTime transaction_time;
   ...
   */
  public Transaction(com.hasanozgan.kafkabank.models.TransactionType transaction_type, java.lang.String customer_id, java.lang.Double amount, java.lang.Boolean is_fraud, org.joda.time.DateTime transaction_time) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: transaction_type = (com.hasanozgan.kafkabank.models.TransactionType)value$; break;
   ...
   */
  public com.hasanozgan.kafkabank.models.TransactionType getTransactionType() {
   ...
   */
  public void setTransactionType(com.hasanozgan.kafkabank.models.TransactionType value) {
   ...
   * @param value the value to set.
   */
  public void setTransactionTime(org.joda.time.DateTime value) {
   ...
   */
  public static com.hasanozgan.kafkabank.models.Transaction.Builder newBuilder() {
    return new com.hasanozgan.kafkabank.models.Transaction.Builder();
  }
   ...
   * @return A new Transaction RecordBuilder
   */
  public static com.hasanozgan.kafkabank.models.Transaction.Builder newBuilder(com.hasanozgan.kafkabank.models.Transaction.Builder other) {
    return new com.hasanozgan.kafkabank.models.Transaction.Builder(other);
  }
   ...
   * @return A new Transaction RecordBuilder
   */
  public static com.hasanozgan.kafkabank.models.Transaction.Builder newBuilder(com.hasanozgan.kafkabank.models.Transaction other) {
    return new com.hasanozgan.kafkabank.models.Transaction.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Transaction>
    ...
    private com.hasanozgan.kafkabank.models.TransactionType transaction_type;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.hasanozgan.kafkabank.models.Transaction.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.hasanozgan.kafkabank.models.Transaction other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.transaction_type)) {
        this.transaction_type = data().deepCopy(fields()[0].schema(), other.transaction_type);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hasanozgan.kafkabank.models.Transaction.Builder setTransactionType(com.hasanozgan.kafkabank.models.TransactionType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hasanozgan.kafkabank.models.Transaction.Builder clearTransactionType() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hasanozgan.kafkabank.models.Transaction.Builder setCustomerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hasanozgan.kafkabank.models.Transaction.Builder clearCustomerId() {
      customer_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hasanozgan.kafkabank.models.Transaction.Builder setAmount(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hasanozgan.kafkabank.models.Transaction.Builder clearAmount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hasanozgan.kafkabank.models.Transaction.Builder setIsFraud(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hasanozgan.kafkabank.models.Transaction.Builder clearIsFraud() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hasanozgan.kafkabank.models.Transaction.Builder setTransactionTime(org.joda.time.DateTime value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hasanozgan.kafkabank.models.Transaction.Builder clearTransactionTime() {
    ...
    public Transaction build() {
      try {
        ...
        record.transaction_type = fieldSetFlags()[0] ? this.transaction_type : (com.hasanozgan.kafkabank.models.TransactionType) defaultValue(fields()[0]);
        ...
        record.is_fraud = fieldSetFlags()[3] ? this.is_fraud : (java.lang.Boolean) defaultValue(fields()[3]);
        record.transaction_time = fieldSetFlags()[4] ? this.transaction_time : (org.joda.time.DateTime) defaultValue(fields()[4]);
        return record;
      } catch (Exception e) {
